...
import VulnSourceCustomSource from "./vuln-sources/VulnSourceCustomSource"; //Added new custom source import
// Repositories
...
export default {
  components: {
    ...
    VulnSourceNvd, VulnSourceGitHubAdvisories, VulnSourceOSVAdvisories, VulnSourceCustomSource,
